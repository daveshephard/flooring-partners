...
urlpatterns = [
    ...
    path("api/companies/<slug:slug>/groups/",             api.api_chart_groups,       name="api_chart_groups"),
    path("api/companies/<slug:slug>/groups/save/",        api.api_save_chart_group,   name="api_save_chart_group"),
    path("api/companies/<slug:slug>/groups/<int:pk>/delete/", api.api_delete_chart_group, name="api_delete_chart_group"),
